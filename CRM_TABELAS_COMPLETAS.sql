-- ============================================
-- VARGASTI CRM - CRIAÇÃO COMPLETA DE TABELAS
...
CREATE INDEX idx_pagamentos_orcamento_id ON public.pagamentos(orcamento_id);
...
CREATE INDEX idx_email_logs_orcamento ON public.email_logs(orcamento_id);
...
-- 5. TABELA: NOTAS_FISCAIS (Automação)
...
CREATE INDEX idx_notas_fiscais_orcamento ON public.notas_fiscais(orcamento_id);
...
CREATE INDEX idx_alertas_orcamento ON public.alertas(orcamento_id);
