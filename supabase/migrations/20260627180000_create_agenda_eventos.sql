...
CREATE INDEX idx_agenda_eventos_user_data ON public.agenda_eventos (user_id, data_inicio);
CREATE INDEX idx_agenda_eventos_cliente   ON public.agenda_eventos (cliente_id) WHERE cliente_id IS NOT NULL;
CREATE INDEX idx_agenda_eventos_chamado   ON public.agenda_eventos (chamado_id) WHERE chamado_id IS NOT NULL;
CREATE INDEX idx_agenda_eventos_os        ON public.agenda_eventos (os_id)      WHERE os_id IS NOT NULL;
