...
function OrcamentosPage() {
  ...
  useEffect(() => {
    ...
    if (searchTerm) resultado = resultado.filter((orc) => orc.numero.toLowerCase().includes(searchTerm.toLowerCase()));
